...
activity_name = "Destroyer-SelfBot"
activity_details = "The Best SelfBot Ever"
activity_state = " "
application_id = 1193291951290712154

streaming_url = "https://github.com/DarkM00n9/Destroyer-SelfBot"
activity_button_one = "Destroyer !"
activity_button_one_answer = "https://github.com/DarkM00n9/Destroyer-SelfBot" # doesn't work for the moment
activity_button_two = "Star it!"
activity_button_two_answer = "https://github.com/DarkM00n9/Destroyer-SelfBot" # doesn't work for the moment

# see &tuto
icon = rpc.get_raw_json("DarkM00n9", "Destroyer-SelfBot", "assets.json")
assets = {"large_image": icon["destroyer"]["large_image"],
          "large_text": "Destroyer-SelfBot",
          "small_image": icon["destroyer"]["small_image"],
          "small_text": None
          }
